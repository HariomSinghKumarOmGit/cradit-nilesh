/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   SENTINOID ECO — SIGNALING SERVER
...
// SECURITY STATUS ENDPOINT: Reports system security state for the Sentinoid Security Shield
let activeConnections = 0;
const startTime = Date.now();

app.get("/api/security-status", (req, res) => {
  const isLocal = req.hostname === "localhost" || req.hostname === "127.0.0.1" || req.ip === "::1";
  res.json({
    airGap: isLocal || !req.hostname.includes("."),
